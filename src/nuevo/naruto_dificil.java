...
import cuestionariodificil.*;
import java.awt.Image;
import javax.swing.Icon;
import javax.swing.ImageIcon;

public class naruto_dificil extends javax.swing.JFrame {

    public naruto_dificil() {
        initComponents();
        setIconImage(new ImageIcon(getClass().getResource("/iconos/naruto21.png")).getImage());
        ImageIcon foto=new ImageIcon(this.getClass().getResource("/img/Naruto-Shippuden.jpg"));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(naruto_dificil.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new naruto_dificil().setVisible(true);
            }
        });
    }
